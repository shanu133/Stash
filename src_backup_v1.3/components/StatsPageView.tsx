import { Trophy, TrendingUp, Music2, Sparkles, Layers, Activity, ArrowLeft } from 'lucide-react';
...
export function StatsPageView({ history, userName, songsThisWeek, streak, onBack, theme }: StatsViewProps) {
  ...
  return (
    <div className="min-h-screen px-6 py-8 md:py-12 bg-[#121212] text-[#E5E5E5] noise-texture relative">
      {/* Back Button */}
      <button
        onClick={onBack}
        className="fixed top-8 left-8 z-50 p-3 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 backdrop-blur-xl transition-all group"
      >
